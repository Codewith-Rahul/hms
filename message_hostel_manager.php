	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="home_manager.php">NTTF<span class="display"></span></a></h1>
...
<?php
    ...
    $query = "SELECT * FROM message WHERE hostel_id ='$hostel_id'";
...
<footer class="py-5">
	<div class="container py-md-5">
		...
		<a class="navbar-brand"  href="https://www.nttftrg.com/" target="_blank">NTTF<span class="display">JAMESHEDPUR</span></a>
		</div>
